<?php
	$q = "SELECT * FROM kategori where id_kategori = ".$_GET['idx']." ";
	$s = mysqli_query($l , $q);
	$d = mysqli_fetch_array($s);
	if (isset($_POST['update'])) {
		$query = "UPDATE kategori SET nama_kategori = '".$_POST['nama']."', link_kategori = '".$_POST['link']."' where id_kategori = ".$_GET['idx']." ";
            ...
            <tbody>
              <tr>
                <td width="40%">
                    ...
                    <input style="width: 100%" name="nama" class="input-data" value="<?php echo $d['nama_kategori'] ?>" /><br />
                    <label style="font-size:20px"><b>Nama Kategori</b></label><br /><br />
                 	<input style="width: 100%" name="link" class="input-data" value="<?php echo $d['link_kategori'] ?>" /><br />
                    <label style="font-size:20px"><b>Link Kategori</b></label><br /><br /></td>
                <td width="10%"></td>
              </tr>
            </tbody>
            </table>
