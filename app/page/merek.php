...
<?php
$q2 = "SELECT * FROM merek where link_merek='".$_GET['m']."' ";
$s2 = mysqli_query($l,$q2) or die(mysqli_error($l));
$data_title_merek = mysqli_fetch_array($s2);
?>
<div class="vtr-title-home"><h1><span>Merek Produk : <?php echo $data_title_merek['nama_merek'] ?> </span></h1></div>
<div class="nest">

<!--Produk-->
<?php
$q1 = "SELECT * FROM produk JOIN merek ON produk.merek=merek.id_merek where link_merek='".$_GET['m']."' ORDER BY id_produk DESC ";
